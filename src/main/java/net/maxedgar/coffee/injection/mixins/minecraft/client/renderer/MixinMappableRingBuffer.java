...
import net.maxedgar.coffee.additions.MappableRingBufferAddition;
...
public abstract class MixinMappableRingBuffer implements MappableRingBufferAddition {
    ...
    /**
     * <a href="https://github.com/MaxEdgar/Coffee/issues/7721">GitHub Issue</a>
     */
    @ModifyArg(
    ...
    @Unique
    @Override
    public boolean coffee$isSafeForClose() {
    ...
    @Unique
    @Override
    public void coffee$awaitAndRotate() {
