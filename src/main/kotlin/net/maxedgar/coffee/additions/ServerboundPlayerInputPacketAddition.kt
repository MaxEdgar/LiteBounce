...
package net.maxedgar.coffee.additions

import net.minecraft.network.protocol.game.ServerboundPlayerInputPacket
import net.minecraft.world.entity.player.Input

interface ServerboundPlayerInputPacketAddition {
    var `coffee$forceSneak`: Boolean

    fun `coffee$getRawInput`(): Input
}
...
inline var ServerboundPlayerInputPacket.forceSneak: Boolean
    get() = (this as ServerboundPlayerInputPacketAddition).`coffee$forceSneak`
    set(value) {
        (this as ServerboundPlayerInputPacketAddition).`coffee$forceSneak` = value
    }

inline val ServerboundPlayerInputPacket.rawInput: Input
    get() = (this as ServerboundPlayerInputPacketAddition).`coffee$getRawInput`()
