...
import net.maxedgar.coffee.features.module.modules.misc.nameprotect.sanitizeForeignInput
import net.maxedgar.coffee.render.AbstractFontRenderer
import net.maxedgar.coffee.render.ClientRenderPipelines
import net.maxedgar.coffee.render.FontFace
import net.maxedgar.coffee.render.FontManager.DEFAULT_FONT_SIZE
import net.maxedgar.coffee.render.WorldRenderEnvironment
import net.maxedgar.coffee.render.drawCustomMesh
import net.maxedgar.coffee.render.drawCustomMeshTextured
import net.maxedgar.coffee.render.drawGlyphOnCurrentLayer
import net.maxedgar.coffee.render.drawHorizontalLine
import net.maxedgar.coffee.render.engine.font.processor.MinecraftTextProcessor
import net.maxedgar.coffee.render.engine.font.processor.ProcessedText
import net.maxedgar.coffee.render.engine.type.Color4b
import net.maxedgar.coffee.render.setColor
import net.maxedgar.coffee.utils.render.textureSetup
