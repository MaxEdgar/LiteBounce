...
import net.maxedgar.coffee.render.mesh.MeshBuildScope
...
/**
 * @see net.maxedgar.coffee.features.module.modules.render.ModuleBlockESP
 * @see net.maxedgar.coffee.features.module.modules.render.ModuleStorageESP
 */
...
class WorldRenderEnvironment internal constructor(
     ...
     *
     * Prefer [net.maxedgar.coffee.render.drawCustomMesh] for regular use.
     */
    fun start(
