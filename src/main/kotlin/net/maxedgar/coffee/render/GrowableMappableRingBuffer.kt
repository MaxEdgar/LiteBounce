...
import net.maxedgar.coffee.additions.isSafeForClose
import net.maxedgar.coffee.utils.text.formatAsCapacity
import net.maxedgar.coffee.utils.client.logger
import net.maxedgar.coffee.utils.render.mapBuffer
...
class GrowableMappableRingBuffer @JvmOverloads constructor(
    ...
    companion object {
         ...
         *
         * @see net.maxedgar.coffee.injection.mixins.blaze3d.MixinRenderSystem.onFlipFrame
         */
        @JvmStatic
        fun cleanup() {
