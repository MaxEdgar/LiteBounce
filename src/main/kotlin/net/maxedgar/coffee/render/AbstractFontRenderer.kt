...
import net.maxedgar.coffee.render.AbstractFontRenderer.DrawParameters.horizontalAnchor
import net.maxedgar.coffee.render.AbstractFontRenderer.DrawParameters.scale
import net.maxedgar.coffee.render.AbstractFontRenderer.DrawParameters.shadow
import net.maxedgar.coffee.render.AbstractFontRenderer.DrawParameters.verticalAnchor
import net.maxedgar.coffee.render.AbstractFontRenderer.DrawParameters.x
import net.maxedgar.coffee.render.AbstractFontRenderer.DrawParameters.y
import net.maxedgar.coffee.render.AbstractFontRenderer.DrawParameters.z
