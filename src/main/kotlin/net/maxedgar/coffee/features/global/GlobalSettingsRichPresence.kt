...
import net.maxedgar.coffee.Coffee.clientBranch
import net.maxedgar.coffee.Coffee.clientCommit
import net.maxedgar.coffee.Coffee.clientVersion
import net.maxedgar.coffee.config.gson.util.jsonArrayOf
import net.maxedgar.coffee.config.gson.util.jsonObject
...
import net.maxedgar.coffee.utils.text.hideSensitiveAddress
 ...
 *
 * todo: use ordered multi choose (https://github.com/MaxEdgar/Coffee/pull/7350), which allows
...
object GlobalSettingsRichPresence : ToggleableValueGroup(
    ...
    private val buttons = jsonArrayOf(
        jsonObject {
            "label"("Website")
            "url"("https://github.com/MaxEdgar/CoffeeV2")
        },
        jsonObject {
            "label"("LiquidProxy")
     ...
     */
    override val running get() = Coffee.isInitialized
    ...
    private enum class RichPresencePart(override val tag: String) : Tagged {
        ...
        fun getText(): String? = when (this) {
            CLIENT_NAME -> Coffee.CLIENT_NAME
            CLIENT_VERSION -> clientVersion
            CLIENT_AUTHOR -> Coffee.CLIENT_AUTHOR
