 ...
 */
package net.maxedgar.coffee.features.module.modules.world.scaffold
...
import net.maxedgar.coffee.features.module.modules.world.scaffold.ModuleScaffold.ScaffoldRotationValueGroup.RotationTimingMode.NORMAL
import net.maxedgar.coffee.features.module.modules.world.scaffold.ModuleScaffold.ScaffoldRotationValueGroup.RotationTimingMode.ON_TICK
import net.maxedgar.coffee.features.module.modules.world.scaffold.ModuleScaffold.ScaffoldRotationValueGroup.RotationTimingMode.ON_TICK_SNAP
import net.maxedgar.coffee.features.module.modules.world.scaffold.ModuleScaffold.ScaffoldRotationValueGroup.considerInventory
import net.maxedgar.coffee.features.module.modules.world.scaffold.ModuleScaffold.ScaffoldRotationValueGroup.rotationTiming
import net.maxedgar.coffee.features.module.modules.world.scaffold.ScaffoldBlockItemSelection.isValidBlock
import net.maxedgar.coffee.features.module.modules.world.scaffold.features.ScaffoldAccelerationFeature
import net.maxedgar.coffee.features.module.modules.world.scaffold.features.ScaffoldAutoBlockFeature
import net.maxedgar.coffee.features.module.modules.world.scaffold.features.ScaffoldBlinkFeature
import net.maxedgar.coffee.features.module.modules.world.scaffold.features.ScaffoldCeilingFeature
import net.maxedgar.coffee.features.module.modules.world.scaffold.features.ScaffoldJumpStrafe
import net.maxedgar.coffee.features.module.modules.world.scaffold.features.ScaffoldLedgeExtension
import net.maxedgar.coffee.features.module.modules.world.scaffold.features.ScaffoldMovementPrediction
import net.maxedgar.coffee.features.module.modules.world.scaffold.features.ScaffoldSpeedLimiterFeature
import net.maxedgar.coffee.features.module.modules.world.scaffold.features.ScaffoldSprintControlFeature
import net.maxedgar.coffee.features.module.modules.world.scaffold.features.ScaffoldStrafeFeature
import net.maxedgar.coffee.features.module.modules.world.scaffold.features.ledge
import net.maxedgar.coffee.features.module.modules.world.scaffold.techniques.ScaffoldBreezilyTechnique
import net.maxedgar.coffee.features.module.modules.world.scaffold.techniques.ScaffoldExpandTechnique
import net.maxedgar.coffee.features.module.modules.world.scaffold.techniques.ScaffoldGodBridgeTechnique
...
import net.maxedgar.coffee.features.module.modules.world.scaffold.tower.ScaffoldTowerHypixel
import net.maxedgar.coffee.features.module.modules.world.scaffold.tower.ScaffoldTowerKarhu
import net.maxedgar.coffee.features.module.modules.world.scaffold.tower.ScaffoldTowerMotion
import net.maxedgar.coffee.features.module.modules.world.scaffold.tower.ScaffoldTowerNone
import net.maxedgar.coffee.features.module.modules.world.scaffold.tower.ScaffoldTowerPulldown
import net.maxedgar.coffee.features.module.modules.world.scaffold.tower.ScaffoldTowerVulcan
...
import net.maxedgar.coffee.utils.block.targetBlockPos
...
import net.maxedgar.coffee.utils.item.PreferAverageHardBlocks
import net.maxedgar.coffee.utils.item.PreferFavourableBlocks
import net.maxedgar.coffee.utils.item.PreferFullCubeBlocks
import net.maxedgar.coffee.utils.item.PreferSolidBlocks
import net.maxedgar.coffee.utils.item.PreferStackSize
import net.maxedgar.coffee.utils.item.PreferWalkableBlocks
...
import net.maxedgar.coffee.utils.math.allEmpty
import net.maxedgar.coffee.utils.math.topCenter
...
object ModuleScaffold : ClientModule("Scaffold", ModuleCategories.WORLD) {
    ...
    /**
     * Temporarily turns on [net.maxedgar.coffee.features.module.modules.movement.speed.ModuleSpeed]
