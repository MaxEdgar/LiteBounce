...
import net.maxedgar.coffee.utils.io.skipLine
import net.maxedgar.coffee.utils.kotlin.mapString
    ...
    private sealed class MessageProvider(name: String) : Mode(name) {
        ...
        object Setting : MessageProvider("Setting") {
            ...
            private val texts by textList("Message", mutableListOf(
                "Coffee Nextgen | CCBlueX on [youtube] | liquidbounce{.net}",
                "I'm using Coffee Nextgen and you should too!",
                "Check out Coffee Nextgen - the best Minecraft client!",
                "Tired of losing? Try Coffee Nextgen!",
            ))
