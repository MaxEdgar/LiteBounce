...
import net.maxedgar.coffee.features.module.modules.`fun`.notebot.nbs.NbsLoader
import net.maxedgar.coffee.features.module.modules.`fun`.notebot.nbs.NbsNoteBlock
...
import net.maxedgar.coffee.utils.text.textLoadingBar
