 ...
 */
package net.maxedgar.coffee.features.module.modules.player.invcleaner

import net.ccbluex.fastutil.enumMapOf
import net.maxedgar.coffee.config.types.list.Tagged
import net.maxedgar.coffee.utils.item.armor.ArmorEvaluation
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.ArmorItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.ArrowItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.BlockItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.BowItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.CrossbowItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.FoodItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.ItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.MaceItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.MiningToolItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.PotionItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.PrimitiveItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.RodItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.ShieldItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.SpearItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.SwordItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.ThrowableItemFacet
import net.maxedgar.coffee.features.module.modules.player.invcleaner.items.WeaponItemFacet
import net.maxedgar.coffee.features.module.modules.world.scaffold.ScaffoldBlockItemSelection
import net.maxedgar.coffee.utils.inventory.ItemSlot
import net.maxedgar.coffee.utils.inventory.VirtualItemSlot
import net.maxedgar.coffee.utils.item.armor.ArmorComparator
import net.maxedgar.coffee.utils.item.armor.ArmorKitParameters
import net.maxedgar.coffee.utils.item.armor.ArmorPiece
import net.maxedgar.coffee.utils.item.foodComponent
import net.maxedgar.coffee.utils.item.getPotionEffects
import net.maxedgar.coffee.utils.item.isAxe
import net.maxedgar.coffee.utils.item.isFood
...
import net.maxedgar.coffee.utils.item.isSpear
