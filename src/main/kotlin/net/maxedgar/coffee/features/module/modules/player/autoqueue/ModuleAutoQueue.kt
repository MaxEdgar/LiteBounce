 ...
 */
package net.maxedgar.coffee.features.module.modules.player.autoqueue

import net.maxedgar.coffee.config.types.list.Tagged
import net.maxedgar.coffee.features.module.ClientModule
import net.maxedgar.coffee.features.module.ModuleCategories
import net.maxedgar.coffee.features.module.modules.player.autoqueue.presets.AutoQueueCustom
import net.maxedgar.coffee.features.module.modules.player.autoqueue.presets.AutoQueueGommeDuels
import net.maxedgar.coffee.features.module.modules.player.autoqueue.presets.AutoQueueHypixelSW
    ...
    private enum class PauseCondition(override val tag: String) : Tagged, BooleanSupplier {
        CLICK_GUI_OPEN("ClickGuiOpen") {
            override fun getAsBoolean(): Boolean {
                ...
                return screen is SearchOverlay
            }
        },
