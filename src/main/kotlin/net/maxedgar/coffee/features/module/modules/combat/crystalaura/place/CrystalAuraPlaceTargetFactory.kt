 ...
 */
package net.maxedgar.coffee.features.module.modules.combat.crystalaura.place
...
import net.maxedgar.coffee.features.module.modules.combat.crystalaura.SubmoduleBasePlace
import net.maxedgar.coffee.features.module.modules.combat.crystalaura.place.SubmoduleCrystalPlacer.getMaxRange
import net.maxedgar.coffee.features.module.modules.combat.crystalaura.place.SubmoduleCrystalPlacer.oldVersion
import net.maxedgar.coffee.features.module.modules.combat.crystalaura.place.conditions.AirAboveCondition
import net.maxedgar.coffee.features.module.modules.combat.crystalaura.place.conditions.AirOldVersionCondition
import net.maxedgar.coffee.features.module.modules.combat.crystalaura.place.conditions.BasePlaceCondition
import net.maxedgar.coffee.features.module.modules.combat.crystalaura.place.conditions.OnlyAboveCondition
import net.maxedgar.coffee.features.module.modules.combat.crystalaura.place.conditions.PredictBlockageCondition
import net.maxedgar.coffee.features.module.modules.combat.crystalaura.place.conditions.ValidHeightCondition
import net.maxedgar.coffee.render.FULL_BOX
import net.maxedgar.coffee.utils.block.getSortedSphere
