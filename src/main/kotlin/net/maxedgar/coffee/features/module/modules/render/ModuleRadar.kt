...
import net.maxedgar.coffee.utils.client.scaledDimension
...
import net.maxedgar.coffee.utils.kotlin.unaryMinus
...
object ModuleRadar : ClientModule("Radar", ModuleCategories.RENDER, aliases = listOf("PointerESP")) {
    ...
    private val pointerModes = choices("PointerMode", 0) {
        arrayOf(
            ...
            PointerMode.ImageMode("Image1", Coffee.resource("misc/triangle1.png").readNativeImage()),
            PointerMode.ImageMode("Image2", Coffee.resource("misc/triangle2.png").readNativeImage()),
        )
    }
