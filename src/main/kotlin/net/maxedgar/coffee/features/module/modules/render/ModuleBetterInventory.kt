...
import net.maxedgar.coffee.additions.drawBorder
import net.maxedgar.coffee.config.types.group.ModeValueGroup
import net.maxedgar.coffee.config.types.group.ToggleableValueGroup
import net.maxedgar.coffee.config.types.list.Tagged
import net.maxedgar.coffee.features.module.ClientModule
import net.maxedgar.coffee.features.module.ModuleCategories
import net.maxedgar.coffee.injection.mixins.minecraft.gui.MixinHudAccessor
...
import net.maxedgar.coffee.utils.item.getCooldown
...
object ModuleBetterInventory : ClientModule("BetterInventory", ModuleCategories.RENDER) {
    ...
    private object HighlightClicked : ToggleableValueGroup(this, "HighlightClicked", enabled = true) {
        ...
        sealed class Mode(choiceName: String) : net.maxedgar.coffee.config.types.group.Mode(choiceName) {
