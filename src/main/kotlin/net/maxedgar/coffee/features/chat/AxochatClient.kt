...
package net.maxedgar.coffee.features.chat
...
import net.maxedgar.coffee.features.chat.packet.AxochatPacket
import net.maxedgar.coffee.features.chat.packet.C2SBanUserPacket
import net.maxedgar.coffee.features.chat.packet.C2SLoginJWTPacket
import net.maxedgar.coffee.features.chat.packet.C2SLoginMojangPacket
import net.maxedgar.coffee.features.chat.packet.C2SMessagePacket
import net.maxedgar.coffee.features.chat.packet.C2SPrivateMessagePacket
import net.maxedgar.coffee.features.chat.packet.C2SRequestJWTPacket
import net.maxedgar.coffee.features.chat.packet.C2SRequestMojangInfoPacket
import net.maxedgar.coffee.features.chat.packet.C2SUnbanUserPacket
import net.maxedgar.coffee.features.chat.packet.PacketDeserializer
import net.maxedgar.coffee.features.chat.packet.PacketSerializer
import net.maxedgar.coffee.features.chat.packet.S2CErrorPacket
import net.maxedgar.coffee.features.chat.packet.S2CMessagePacket
import net.maxedgar.coffee.features.chat.packet.S2CMojangInfoPacket
import net.maxedgar.coffee.features.chat.packet.S2CNewJWTPacket
import net.maxedgar.coffee.features.chat.packet.S2CPrivateMessagePacket
import net.maxedgar.coffee.features.chat.packet.S2CSuccessPacket
...
import net.maxedgar.coffee.utils.io.clientChannelAndGroup
import net.maxedgar.coffee.utils.io.syncSuspend
import java.net.URI
