...
import net.maxedgar.coffee.features.command.CommandManager.getSubCommand
import net.maxedgar.coffee.features.command.commands.client.CommandBind
import net.maxedgar.coffee.features.command.commands.client.CommandBinds
import net.maxedgar.coffee.features.command.commands.client.CommandClear
import net.maxedgar.coffee.features.command.commands.client.CommandConfig
import net.maxedgar.coffee.features.command.commands.client.CommandDebug
import net.maxedgar.coffee.features.command.commands.client.CommandFriend
import net.maxedgar.coffee.features.command.commands.client.CommandHelp
import net.maxedgar.coffee.features.command.commands.client.CommandHide
import net.maxedgar.coffee.features.command.commands.client.CommandLocalConfig
import net.maxedgar.coffee.features.command.commands.client.CommandPanic
import net.maxedgar.coffee.features.command.commands.client.CommandScript
import net.maxedgar.coffee.features.command.commands.client.CommandTargets
import net.maxedgar.coffee.features.command.commands.client.CommandToggle
import net.maxedgar.coffee.features.command.commands.client.CommandValue
import net.maxedgar.coffee.features.command.commands.client.client.CommandClient
import net.maxedgar.coffee.features.command.commands.ingame.CommandCenter
import net.maxedgar.coffee.features.command.commands.ingame.CommandCoordinates
import net.maxedgar.coffee.features.command.commands.ingame.CommandPing
import net.maxedgar.coffee.features.command.commands.ingame.CommandRemoteView
import net.maxedgar.coffee.features.command.commands.ingame.CommandSay
import net.maxedgar.coffee.features.command.commands.ingame.CommandServerInfo
import net.maxedgar.coffee.features.command.commands.ingame.CommandTps
import net.maxedgar.coffee.features.command.commands.ingame.CommandUsername
import net.maxedgar.coffee.features.command.commands.ingame.creative.CommandItemEnchant
import net.maxedgar.coffee.features.command.commands.ingame.creative.CommandItemGive
import net.maxedgar.coffee.features.command.commands.ingame.creative.CommandItemRename
import net.maxedgar.coffee.features.command.commands.ingame.creative.CommandItemSkull
import net.maxedgar.coffee.features.command.commands.ingame.creative.CommandItemStack
import net.maxedgar.coffee.features.command.commands.ingame.fakeplayer.CommandFakePlayer
...
import net.maxedgar.coffee.features.command.commands.module.CommandInvsee
import net.maxedgar.coffee.features.command.commands.module.CommandXRay
...
import net.maxedgar.coffee.features.command.commands.translate.CommandAutoTranslate
import net.maxedgar.coffee.features.command.commands.translate.CommandTranslate
...
import net.maxedgar.coffee.utils.math.levenshtein
