...
/*
 * Coffee Hacked Client
 * A free open source mixin-based injection hacked client for Minecraft using Minecraft Forge.
 * https://github.com/MaxEdgar/Coffee/
 */
package net.maxedgar.coffee.lang
...
object LanguageManager : ValueGroup("Language") {
    ...
    private val languageRegistry = ConcurrentHashMap<ClientLanguage, net.maxedgar.coffee.lang.ClientLanguage>()

    private fun loadLanguage(choice: ClientLanguage): net.maxedgar.coffee.lang.ClientLanguage? {
            ...
            runCatching {
                languageRegistry.computeIfAbsent(choice) {
                    val languageFile = javaClass.getResourceAsStream(
                        "/resources/coffee/lang/${choice.code}.json"
                    )
