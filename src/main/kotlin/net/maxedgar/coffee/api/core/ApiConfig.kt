 ...
 */
package net.maxedgar.coffee.api.core
...
class ApiConfig(
    ...
    companion object {
        ...
        private val API_URLS = arrayOf(
            ...
            //   The only way to use this URL is to set the property `net.maxedgar.coffee.api.url` to
            //   this URL which the LiquidLauncher does when the user has confirmed it.
            // "http://nossl.api.liquidbounce.net"
        )

        const val CLIENT_CDN = "https://cloud.liquidbounce.net/Coffee"
        ...
        /**
         * Defines the API environment for Coffee.
         * This should be initialized before the API is used through [net.maxedgar.coffee.Coffee].
         */
        ...
        suspend fun lookup(): ApiConfig {
            ...
            val propertyUrl = System.getProperty("net.maxedgar.coffee.api.url")
            if (propertyUrl != null) {
