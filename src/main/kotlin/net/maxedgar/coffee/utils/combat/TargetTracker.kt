...
import net.maxedgar.coffee.config.types.ValueType.FLOAT
import net.maxedgar.coffee.config.types.ValueType.FLOAT_RANGE
import net.maxedgar.coffee.config.types.ValueType.INT
import net.maxedgar.coffee.config.types.ValueType.INT_RANGE
...
import net.maxedgar.coffee.utils.client.DummyRangedValueProvider
import net.maxedgar.coffee.utils.client.NoneRangedValueProvider
import net.maxedgar.coffee.utils.client.RangedValueProvider
import net.maxedgar.coffee.utils.client.player
import net.maxedgar.coffee.utils.client.world
import net.maxedgar.coffee.utils.entity.getActualHealth
