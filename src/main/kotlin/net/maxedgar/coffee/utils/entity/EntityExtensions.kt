...
import net.maxedgar.coffee.interfaces.ClientInputAddition
import net.maxedgar.coffee.interfaces.LocalPlayerAddition
import net.maxedgar.coffee.utils.aiming.data.Rotation
import net.maxedgar.coffee.utils.block.DIRECTIONS_EXCLUDING_UP
import net.maxedgar.coffee.utils.block.collisionShape
import net.maxedgar.coffee.utils.block.getBlock
import net.maxedgar.coffee.utils.block.isBlastResistant
import net.maxedgar.coffee.utils.block.raycast
...
import net.maxedgar.coffee.utils.math.iterateBottomLayerBlockPos
import net.maxedgar.coffee.utils.math.minus
import net.maxedgar.coffee.utils.movement.DirectionalInput
import net.maxedgar.coffee.utils.movement.findEdgeCollision
...
inline var ClientInput.movementForward: Float
    get() = moveVector.y
    set(value) {
        (this as ClientInputAddition).`coffee$setMovementInput`(moveVector.copy(y = value))
    }

inline var ClientInput.movementSideways: Float
    get() = moveVector.x
    set(value) {
        (this as ClientInputAddition).`coffee$setMovementInput`(moveVector.copy(x = value))
    }
...
val ClientInput.untransformed: Input
    get() = (this as ClientInputAddition).`coffee$getUntransformed`()

val ClientInput.initial: Input
    get() = (this as ClientInputAddition).`coffee$getInitial`()
...
val LocalPlayer.airTicks: Int
    get() = (this as LocalPlayerAddition).`coffee$getAirTicks`()

val LocalPlayer.onGroundTicks: Int
    get() = (this as LocalPlayerAddition).`coffee$getOnGroundTicks`()
