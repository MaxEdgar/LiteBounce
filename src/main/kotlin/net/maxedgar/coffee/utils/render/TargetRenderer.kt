...
import net.maxedgar.coffee.config.utils.TextureMode
...
import net.maxedgar.coffee.render.drawCircle
import net.maxedgar.coffee.render.drawCircleOutline
import net.maxedgar.coffee.render.drawCustomMesh
import net.maxedgar.coffee.render.drawGradientCircle
import net.maxedgar.coffee.render.drawSquareTexture
import net.maxedgar.coffee.render.drawTexQuad
import net.maxedgar.coffee.render.drawTriangle
...
import net.maxedgar.coffee.utils.entity.lastRenderPos
import net.maxedgar.coffee.utils.math.minus
import net.maxedgar.coffee.utils.math.toDegrees
import net.maxedgar.coffee.utils.render.WorldToScreen.calculateScreenPos
    ...
    sealed class World(name: String) : TargetRenderAppearance<WorldRenderEnvironment>(name) {
        ...
        class Image(owner: ToggleableValueGroup, override val parent: ModeValueGroup<*>) : World("Image") {
            ...
            private enum class PresetTexture(override val tag: String, val path: String) : TextureMode.Builtin.Preset {
                ...
                override val texture = Coffee.resource(this.path)
...
private val ghostModeTexture = Coffee.resource("particles/glow.png")
