...
package net.maxedgar.coffee.utils.client.error

import net.maxedgar.coffee.Coffee
import net.maxedgar.coffee.utils.client.browseUrl
import net.maxedgar.coffee.utils.client.error.errors.ClientError
...
class ErrorHandler private constructor(
        ...
        fun fatal(
            ...
            ErrorHandler(error, finalQuickFix, additionalMessage, finalNeedToReport).apply {
                ...
                if (buildAndShowMessage()) {
                    browseUrl("https://github.com/MaxEdgar/Coffee/issues/new?template=bug_report.yml")
                }
    ...
    private inline val title get() = "${Coffee.CLIENT_NAME} Nextgen"
    ...
    private inline fun systemSpecs(): StringBuilder = builder.append(
        """
            ...
            Client version: ${Coffee.clientVersion} (${Coffee.clientCommit})
        """.trimIndent()
    )
