...
import net.maxedgar.coffee.injection.mixins.minecraft.gui.MixinChatScreenAccessor
import net.maxedgar.coffee.interfaces.TextColorAddition
...
private val clientPrefix: Component = "".asText()
    ...
    .append(gradientText("Coffee", Color4b.fromHex("#4677ff"), Color4b.fromHex("#24AA7F")))
