 ...
 */
package net.maxedgar.coffee.config

import com.google.gson.Gson
import com.google.gson.JsonElement
import com.google.gson.JsonObject
import net.maxedgar.coffee.Coffee
import net.maxedgar.coffee.config.gson.fileGson
...
import net.maxedgar.coffee.utils.io.createZipArchive
import net.maxedgar.coffee.utils.io.extractZip
import java.io.File
...
object ConfigSystem {
    ...
    val rootFolder = File(
        mc.gameDirectory, Coffee.CLIENT_NAME
    ).apply {
