...
import net.maxedgar.coffee.config.gson.stategies.ProtocolExclude
...
import net.maxedgar.coffee.script.asArray
import net.maxedgar.coffee.script.asDoubleArray
import net.maxedgar.coffee.script.asIntArray
...
open class Value<T : Any>(
    ...
    /**
     * If true, the description won't be bound to any [net.maxedgar.coffee.config.types.group.ValueGroup].
     */
