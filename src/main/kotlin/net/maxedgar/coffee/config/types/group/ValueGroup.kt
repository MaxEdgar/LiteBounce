 ...
 */
package net.maxedgar.coffee.config.types.group
...
import net.maxedgar.coffee.config.types.BindValue
import net.maxedgar.coffee.config.types.Config
import net.maxedgar.coffee.config.types.CurveValue
import net.maxedgar.coffee.config.types.CurveValue.Axis
import net.maxedgar.coffee.config.types.FileDialogMode
import net.maxedgar.coffee.config.types.FileValue
...
import net.maxedgar.coffee.config.types.Vec3Value
import net.maxedgar.coffee.config.types.list.ChoiceListValue
import net.maxedgar.coffee.config.types.list.ItemListValue
import net.maxedgar.coffee.config.types.list.ListValue
import net.maxedgar.coffee.config.types.list.MultiChoiceListValue
import net.maxedgar.coffee.config.types.list.MutableListValue
import net.maxedgar.coffee.config.types.list.RegistryListValue
import net.maxedgar.coffee.config.types.list.RegistryMutableListValue
import net.maxedgar.coffee.config.types.list.Tagged
import net.maxedgar.coffee.config.types.list.Tagged.Companion.asTagged
