...
package net.maxedgar.coffee.config.gson
...
import net.maxedgar.coffee.config.gson.adapter.InputBindAdapter
import net.maxedgar.coffee.config.gson.adapter.InstantAdapter
import net.maxedgar.coffee.config.gson.adapter.IntRangeAdapter
import net.maxedgar.coffee.config.gson.adapter.LocalDateAdapter
import net.maxedgar.coffee.config.gson.adapter.LocalDateTimeAdapter
import net.maxedgar.coffee.config.gson.adapter.MinecraftAccountAdapter
import net.maxedgar.coffee.config.gson.adapter.OffsetDateTimeAdapter
import net.maxedgar.coffee.config.gson.adapter.OptionalAdapter
import net.maxedgar.coffee.config.gson.adapter.RangeAdapter
import net.maxedgar.coffee.config.gson.adapter.SimpleStringTypeAdapter
import net.maxedgar.coffee.config.gson.adapter.Vec2fAdapter
import net.maxedgar.coffee.config.gson.adapter.Vec3dAdapter
import net.maxedgar.coffee.config.gson.adapter.Vec3iAdapter
import net.maxedgar.coffee.config.gson.adapter.Vector2fcAdapter
import net.maxedgar.coffee.config.gson.serializer.ModeValueGroupSerializer

import net.maxedgar.coffee.config.gson.serializer.SupplierSerializer
import net.maxedgar.coffee.config.gson.serializer.TaggedSerializer
import net.maxedgar.coffee.config.gson.serializer.ValueGroupSerializer
import net.maxedgar.coffee.config.gson.serializer.minecraft.ItemStackSerializer
import net.maxedgar.coffee.config.gson.serializer.minecraft.ScreenSerializer
import net.maxedgar.coffee.config.gson.serializer.minecraft.ServerInfoSerializer
import net.maxedgar.coffee.config.gson.serializer.minecraft.SessionSerializer
import net.maxedgar.coffee.config.gson.serializer.minecraft.StatusEffectInstanceSerializer
import net.maxedgar.coffee.config.gson.serializer.minecraft.StringRepresentableSerializer
import net.maxedgar.coffee.config.gson.stategies.ExcludeStrategy
 ...
 * These adapters include anything from Kotlin classes to Minecraft and Coffee types
